  ...
  return (
    <div className="section-page">
      ...
      <main className="sp-main">
        ...
        <div className="fit-content founder-bios">
          <div className="founder-bio-block">
            <span className="sp-label">Nima Gougerchian — Co-Founder</span>
          ...
          <div className="founder-lucy-split">
            <div>
              <span className="sp-label">Lucy Sager — Co-Founder</span>
            ...
            <div className="fit-visual">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/lucy-founder.jpg" alt="Lucy Sager, Co-Founder of Arya, Los Angeles" />
            </div>
          </div>
