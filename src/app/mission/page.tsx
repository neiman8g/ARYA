      ...
      <main className="sp-main mission-main">
        ...
        <div className="mission-pillars">
          {[
            ...
            { n: "02", t: "Skin Conscious", b: "Every Arya fabric is chosen with your health in mind. No harmful dyes. No toxic synthetics against your body. Materials that feel as good as they perform. Because luxury should never come at the cost of your wellbeing. What touches your skin should be as intentional as everything else you choose." },
